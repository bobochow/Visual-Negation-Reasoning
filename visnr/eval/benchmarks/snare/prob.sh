...
# CUDA_VISIBLE_DEVICES=2 python llava_cot_decoding_batch.py --model-path llava-hf/llava-1.5-7b-hf --batch_size 12 --max_instances 1000 --output_dir ./outputs/llava_1.5_7b_hf/zeroshot_cot_decoding  --extra_info zeroshot_cot --num_branches 10

# CUDA_VISIBLE_DEVICES=1 python llava_mme_eval_cot_decoding_batch.py --model-path llava-hf/llava-1.5-7b-hf --batch_size 16 --max_instances 1000 --output_dir ./outputs/llava_1.5_7b_hf/zeroshot_cot_decoding  --extra_info zeroshot_cot --num_branches 10


python llava_hf_infer_batched.py --model-path llava-hf/llava-1.5-13b-hf --batch_size 8 --max_instances -1 --output_dir ./outputs/llava-1.5-13b-hf/subclausal/zeroshot  --extra_info subclausal_zeroshot --subclausal;

# python llava_hf_infer_batched.py --model-path llava-hf/llava-1.5-13b-hf --batch_size 4 --max_instances -1 --output_dir ./outputs/llava-1.5-13b-hf/subclausal/zeroshot_cot_content  --extra_info subclausal_zeroshot_cot --cot_type cot --subclausal;


CUDA_VISIBLE_DEVICES=2 python llava_hf_infer_batched.py --model-path llava-hf/llava-1.5-7b-hf --batch_size 16 --max_instances -1 --output_dir ./outputs/llava_1.5_7b_hf/zeroshot  --extra_info zeroshot --seed 3 --temperature 0
