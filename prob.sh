...
python llava_hf_infer_batched.py --model-path llava-hf/llava-1.5-7b-hf --batch_size 8 --max_instances -1 --output_dir ./outputs/llava_1.5_7b/zeroshot_cot_DNeg  --extra_info zeroshot_cot_DNeg --cot_type DNeg 
...
# CUDA_VISIBLE_DEVICES=3 python instructblip_hf_infer_batched.py --model-path Salesforce/instructblip-flan-t5-xxl --model_name instructblip --batch_size 8 --max_instances -1 --output_dir ./outputs/instructblip-flan-t5-xxl/zeroshot_cot_content --extra_info zeroshot_cot_content --cot_type cot 
